      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {CONTACTS.map((contact) => (
            <a href={contact.url} target="_blank" key={contact.name} className="hover:scale-105 transition-all duration-300 w-72 flex flex-col items-center border border-black border-b-8 p-10 rounded-xl gap-3">
